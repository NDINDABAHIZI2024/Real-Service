                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="footer-widget">
                            <h2 class="widget-title">Real Service</h2>
...
?>
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                        <div class="footer-widget widget-newsletter">
                            <!-- newsletter block -->
                            <h2 class="widget-title">Subscribe for Updates & Announcements</h2>
                            <p>Enter your email to receive the latest news, event tips, and service updates directly to your inbox...</p>
                            <form method="post">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="copyright-content">
                                <p> Real Service Management System </p>
                            </div>
                        </div>
                    </div>
                </div>
